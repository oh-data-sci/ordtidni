# helper functions for handling filesystem and xml files
...
def get_paragraphs_sentences(text_paragraphs, namespace={'tei': 'http://www.tei-c.org/ns/1.0'}):
    """
...
def get_sentence_lemmas(sentences, namespace={'tei': 'http://www.tei-c.org/ns/1.0'}):
    """
...
def get_sentence_words(sentences, namespace={'tei': 'http://www.tei-c.org/ns/1.0'}):
    """
    given a list of sentences in a well-formed tei xml file, 
...
def get_sentence_lemma_word_pos(sentences, namespace={'tei': 'http://www.tei-c.org/ns/1.0'}):
    """
    given a list of sentences in a well-formed tei xml file, 
